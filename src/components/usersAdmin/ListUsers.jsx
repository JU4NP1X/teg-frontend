            ...
            >
              ...
              <TableBody>
                {!loading ? users.map((user, index) => {
                  return (
                    <TableRow hover key={user.key}>
                      <TableCell align='left'>
                        <img src={`/img/${user.company.cmpValue ?? 'mayoreo'}-category.png`} style={{ height: '25px', width: 'auto' }} />
                      </TableCell>
                      ...
                      <TableCell>
                        <Accordion>
                          <AccordionSummary
                            ...
                            id='panel1a-header'
                          >
                            {user.roles.length ? user.roles[0].rolName : 'N/A'}
                          </AccordionSummary>
                          <AccordionDetails>
                            {user.roles.length > 1
                              ? user.roles.map((role) => (
                  ...
                  <TableRow hover rowSpan={5} style={{ height: 'calc(60vh - 70px)' }}>
