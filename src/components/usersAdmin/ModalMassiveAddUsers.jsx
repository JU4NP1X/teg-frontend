...
const props = ['Nombre', 'Apellido', 'Email', 'Compañía', 'Estatus', 'Rol', 'Resultado']
...
`
const ModalMassiveAddUsers = ({ setVisibleMassiveAddUsers, visibleMassiveAddUsers }) => {
  ...
  return (<>
    <Dialog open={visibleMassiveAddUsers} scroll='paper' maxWidth='sm' sx={{ height: 680 }} >
      ...
      <DialogContent>
        <DropzoneArea
          ...
          dropzoneText={filesState.length ? 'Archivo subido éxito, presione cargar para iniciar el proceso.' : 'Haga click o arrastre el archivo a esta área para cargarlo'}
          getFileLimitExceedMessage={() => 'Se excedió la cantidad máxima permitida de archivos. Solo se permite 1 archivo '}
          ...
          getDropRejectMessage={() => 'El archivo fue rechazado. Por favor seleccione un archivo con formato .csv'}
