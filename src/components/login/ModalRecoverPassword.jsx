...
const RecoverPassword = ({ openRecoverPassDialog, setOpenRecoverPassDialog }) => {
  ...
  return (<>
    <Dialog open={openRecoverPassDialog} fullWidth={true} maxWidth='sm' sx={{ height: 680 }}>
      ...
      <DialogContent>
        <Typography
          ...
          sx={{ fontSize: 15 }}
        >
          Ingrese su correo electrónico con el que se registró en la página, en el mismo recibirá una nueva contraseña para ingresar.
        </Typography>
        <ValidatorForm
