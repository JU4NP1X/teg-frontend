      ...
      <Dialog open={openRegisterDialog} maxWidth={'sm'} sx={{ height: 680 }}>
        ...
        <DialogContent>
          <Typography component={'p'} variant={'h5'} sx={{ fontSize: 15 }}>
            Ingrese sus datos de registro, los mismos serán validados por el
            administrador. Si los mismos resultan satisfactorios, este procederá
            a activar su cuenta para que pueda acceder a la página.
          </Typography>
          <ValidatorForm
