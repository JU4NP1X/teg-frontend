  ...
  return (
    <Card sx={{ minHeight: '100%', }} >
      <CardContent >
        <FormControl size="small" fullWidth>
          ...
          <TextField
            label='Título'
            id='title'
            placeholder='Ingrese el título del texto a claseficar o bien, puede subir un PDF'
            fullWidth
          />
          <TextField
            label='Resumen'
      ...
      <Box sx={{ display: 'flex', alignItems: 'between', px: 1, pb: 1 }}>
        <Button variant='outlined' startIcon={<Upload />} onClick={() => { console.log("HOSDAAASD"); setOpenPDFExtractor(true) }}>
          Subir PDF
        </Button>
      ...
      <PDFExtractor open={openPDFExtractor} onClose={() => setOpenPDFExtractor(false)} />
    </Card>
  )
}
